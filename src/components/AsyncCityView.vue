...
<template>
    ...
    <!-- Weather Overview -->
        <div class="flex flex-col items-center text-white py-12">
            ...
            <img class="h-auto" :src="`http://openweathermap.org/img/wn/${weatherData.current.weather[0].icon}@2x.png`" :alt="weatherData.current.weather[0].description">  
        </div>
        ...
        <div class="max-w-screen-md w-full py-12">
            <div class="mx-8 text-white">
                ...
                <div
                  ...
                  <img class="w-auto h-[50px] object-cover" :src="`http://openweathermap.org/img/wn/${hourData.weather[0].icon}@2x.png`" :alt="weatherData.current.weather[0].description">
        ...
        <div class="max-w-screen-md w-full py-12">
            <div class="mx-8 text-white">
                ...
                <div v-for="day in weatherData.daily" :key="day.dt" class="flex item-center">
                    <p class="flex-1">
                  ...
                  <img class="w-[50px] h-[50px] object-cover" :src="`http://openweathermap.org/img/wn/${day.weather[0].icon}@2x.png`" :alt="weatherData.current.weather[0].description">
